...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const loginResult = loginUser(email.trim().toLowerCase(), password);
    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center px-4">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="bg-bg-card border border-border-subtle rounded-2xl p-8">
          <h2 className="text-xl font-bold text-text-primary mb-6">Crear cuenta</h2>
          ...
          <p className="text-center text-text-secondary text-sm mt-6">
            ¿Ya tienes cuenta?{' '}
            <Link to="/login" className="text-accent-coral hover:underline font-medium">
              Iniciar sesión
            </Link>
          </p>
        </div>
